                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td  style="valign: middle;">
                                    <a href="admin/data/pranaTrash/{{ $request->rid }}" style="color: red; top-margin: 51px;" onclick="return confirm('Set status cancel for Request Request {{ $request->id }} ?')"><i class="fa fa-times" style="font-size: 110%;"></i></a>
                                @else
                                <td><i class="fa fa-{{ $request->spstatus }}" style="font-size: 150%; color: red;"></i></td>
                                <td  style="valign: middle;">
                                    <a href="admin/data/pranaDone/{{ $request->rid }}" style="color: green;" onclick="return confirm('Set status success for Request {{ $request->id }} ?')"><i class="fa fa-check" style="font-size: 110%;"></i></a>
                                @endif
                                </td>
                            </tr>
                            @endforeach
